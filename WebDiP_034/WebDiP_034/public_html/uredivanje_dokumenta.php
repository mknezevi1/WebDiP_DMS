...
<html>
    <head>
        ...
        <title>uređivanje dokumenata</title>  
    ...
    <body>
        ...
        <div id="dinamicko">            
            ...
            $baza = new Baza();
            //default slika=1, ekstenzija=8 (.txt)
            $dokument = $baza->upisiDokument('1','8');
            ...
            <form id="form1" method="post" name="form1" action="upis.php">
                <table>   
                    <tr>
                        <td><label id="autorl" for="autor">autor</label></td>
                        <td><input id="autor" name="autor" type="text" readonly value="<?php echo $autor; ?>"></td>
                    </tr>
                    
                    <tr>
                        <td><label id="dokumentl" for="dokument">dokument</label></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <br>
                            <textarea id="sadrzaj" required="required" name="sadrzaj" rows="30" cols="100" maxlength="1000"></textarea>
                            <br>
                        </td>
                    </tr>
                </table>
