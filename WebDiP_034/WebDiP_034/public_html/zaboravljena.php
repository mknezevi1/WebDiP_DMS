...
//ako imam prijavljenog korisnika nudim mogucnost odjave, ako je neprijavljen ima link za login
        ...
        <div id="dinamicko">
            <form id="formaprijava" method="post" action="generiraj_lozinku.php">
                <table>
                    <tr>
                        <td><label id="emaill" for="email">email</label></td>
                        <td><input id="email" required="required" name="email" placeholder="email" autofocus="autofocus"></td>
                    </tr>
